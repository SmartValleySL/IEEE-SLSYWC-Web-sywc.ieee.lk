...
<head>
	...
	<!-- Site Title -->
	<title>Not Found | IEEE SLSYW Congress 2018</title>
	<!--Favicon-->
...
<body>
	...
	<div id="page-banner-area" class="page-banner-area" style="background-image:url(images/banner/banner3.jpg)">
		...
		<div class="page-banner-title">
	        ...
	        <strong>	<font size="35" color="white">404: URL Not Found Error Encountered</font> </strong>
         </div>
                ...
                <div class="row">
                    <div class="error-page text-center">
                        ...
                        <div class="error-message">
                            <h3>Oops... URL You entered is does not exsist!</h3>
