...
<head>
    <title>Registration | IEEE Student/YP/WIE Congress - 2018</title>
    <meta charset="utf-8">
...
<script>
  ...
  fbq('init', '145886729381764');
  fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=145886729381764&amp;ev=PageView&amp;noscript=1"
/></noscript>
    ...
    <div class='container'>
        <div class="row">
            <div class='tuna-signup-left col-md-4 col-sm-4'>
                <img class='tuna-signup-logo' src='images/logo-signup.png' width="150" alt="logo"/>
                <p>IEEE SYWC SRI LANKA 2018</p>
                <p class="tuna-trial">Register to the most amazing congress in 2018</p>
                <hr/>

                <strong><font size="5" color="#808080">Need any help..?</font> </strong><br>
                <small><font color="#808080"> Feel free to ask any trouble in authentication:</font></small><br>
                <p>E-mail: help@sywc.ieee.lk</p>
                <p>Call: +94(77) 431 9 431</p>

                <hr/>

               <a href="../index.php"> <img class='tuna-signup-logo' src='images/home.png' width="80" alt="logo" title="Go Back to Home"/> </a>
            ...
            <div class='tuna-signup-right col-md-8 col-sm-8 '>
                ...
                <div class="tuna-steps">
                    ...
                    <div class="step step-confirm " data-step-id='5'>
                        <form action='#' name='signupForm' autocomplete="off" class="form-horizontal">
                ...
                <div class='button-container'>
                    <div>
                        ...
                        <span>or</span><br><br>
                        <a href="Login" class="btn btn-white btn-rounded nextStep" tabindex="0">Login</a>
                    </div>
